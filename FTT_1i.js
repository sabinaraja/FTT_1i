...
let expName = 'FTT_1i';  // from the Builder filename that created this script
let expInfo = {};
...
flowScheduler.add(quitPsychoJS, 'You will now be redirected to the next part of the experiment. ', true);
...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': 'face_trust_Face_Stimuli.xlsx', 'path': 'face_trust_Face_Stimuli.xlsx'},
    ...
    {'name': 'Trustworthiness/010_y_f_n_a.jpg', 'path': 'Trustworthiness/010_y_f_n_a.jpg'},
    {'name': 'Trustworthiness/063_y_f_n_a.jpg', 'path': 'Trustworthiness/063_y_f_n_a.jpg'},
    {'name': 'Trustworthiness/071_y_f_n_b.jpg', 'path': 'Trustworthiness/071_y_f_n_b.jpg'},
    {'name': 'Trustworthiness/085_y_f_n_b.jpg', 'path': 'Trustworthiness/085_y_f_n_b.jpg'},
    {'name': 'Trustworthiness/090_y_f_n_a.jpg', 'path': 'Trustworthiness/090_y_f_n_a.jpg'},
    {'name': 'Trustworthiness/025_y_m_n_b.jpg', 'path': 'Trustworthiness/025_y_m_n_b.jpg'},
    {'name': 'Trustworthiness/031_y_m_n_b.jpg', 'path': 'Trustworthiness/031_y_m_n_b.jpg'},
    {'name': 'Trustworthiness/037_y_m_n_b.jpg', 'path': 'Trustworthiness/037_y_m_n_b.jpg'},
    {'name': 'Trustworthiness/049_y_m_n_b.jpg', 'path': 'Trustworthiness/049_y_m_n_b.jpg'},
    {'name': 'Trustworthiness/062_y_m_n_b.jpg', 'path': 'Trustworthiness/062_y_m_n_b.jpg'},
...
async function updateInfo() {
  ...
  psychoJS.setRedirectUrls('https://sabinaraja.github.io/onlinestudy_B/', '');
...
async function experimentInit() {
  ...
  text = new visual.TextStim({
    win: psychoJS.window,
    name: 'text',
    text: 'Welcome to part 1 of the Facial Trustworthiness Ratings Task!',
    font: 'Open Sans',
    units: undefined, 
  ...
  text_9 = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_9',
    text: 'What is your Prolific ID?\nType your 24-character Prolific ID below. When you are ready to proceed, click ENTER. \nPlease DO NOT proceed before entering your Prolific ID. ',
    font: 'Open Sans',
    units: undefined, 
  ...
  text_6 = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_6',
    text: 'Thank you for completing part 1 of the Facial Trustworthiness Ratings Task!\n\nPress any key to terminate this window. ',
    font: 'Open Sans',
    units: undefined, 
    pos: [0, 0], height: 0.05,  wrapWidth: undefined, ori: 0.0,
    languageStyle: 'LTR',
...
function ProlificIDRoutineBegin(snapshot) {
  return async function () {
    ...
    ProlificIDComponents.push(text_9);
    ProlificIDComponents.push(textbox);
    ProlificIDComponents.push(key_resp_4);
    
    for (const thisComponent of ProlificIDComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function trialsLoopBegin(trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    trials = new TrialHandler({
      ...
      nReps: 1, method: TrialHandler.Method.RANDOM,
      extraInfo: expInfo, originPath: undefined,
      trialList: 'face_trust_Face_Stimuli.xlsx',
...
function practicefaces_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of practicefaces_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Blank_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Blank_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Trustworthiness_RatingRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Trustworthiness_RatingComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function TrialFacesRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of TrialFacesComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
